...
> **Personal note:** I keep my skills directory symlinked to `~/dotfiles/codex/skills` so they stay version-controlled alongside my other dotfiles. Handy if you manage configs with a dotfiles repo.
